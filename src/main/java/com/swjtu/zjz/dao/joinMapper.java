...
public interface joinMapper {
    ...
    @Select("select house.house_id,house_tenant.tenant_id,house_tenant.tenant_name,house_address,house_monthlyrent,house_detail,house_area,house_use," +
    ...
    @Select("select house.house_id,house_tenant.tenant_id,house_owner.owner_name,house_tenant.tenant_name,house_address,house_monthlyrent," +
            "house_detail,house_area,house_use, house_type,house_floor,house_decoration,house.rent_time,rental_situation,contract_startdate," +
            "contract_enddate from house_tenant,house_contract,house,house_owner " +
