...
public interface joinMapper {
    ...
    @Select("select house.house_id,house_address,house_monthlyrent,house_detail,house_area,house_use,house_type,house_floor,house_decoration,rent_time,apply_situation" +
            " from house inner join house_apply on house.house_id = house_apply.house_id where house_apply.tenant_id = #{id}")
    List<House> getApplyHouse(Integer id);
